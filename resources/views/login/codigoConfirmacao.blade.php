...
<nav class="navbar navbar-expand-lg navbar-light bg-light navbar navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<div id="embaixo2" class="mx-auto container-fluid">
		<p><b>Para recuperação da palavra-chave, por favor,
		insira o codigo de recuperação (enviado para o seu e-mail)</b></p>
	<input type="text" class="textField" name="codigo" placeholder="codigo">
		</p>
		<button type="button" class="btn btn-success">Confirmar</button>
		<button type="button" class="btn btn-info">Reenviar codigo</button>
	</div>
</div>
</body>
</html>
